...
@Audited
public class NonMultitenancyPartDefinitionChoiceGroup {
    ...
    private NonMultitenancyPartDefinition parentPartDefinition;
    ...
    public NonMultitenancyPartDefinitionChoiceGroup() {
    }
    ...
    public NonMultitenancyPartDefinition getParentPartDefinition() {
        return parentPartDefinition;
    }

    public void setParentPartDefinition(NonMultitenancyPartDefinition parentPartDefinition) {
