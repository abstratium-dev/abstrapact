...
import dev.abstratium.abstrapact.non_multitenancy.sales.boundary.dto.PartInstanceAttributeRequest;
import dev.abstratium.abstrapact.non_multitenancy.sales.boundary.dto.PartInstanceRequest;
import dev.abstratium.abstrapact.product.boundary.dto.PartAttributeAllowedValueRequest;
...
import dev.abstratium.abstrapact.product.entity.PartDefinitionChoiceGroup;
...
class NonMultitenancyCustomerProductInstanceServiceTest {
    ...
    void rejectsWhenRequiredAttributeMissing() throws Exception {
        ...
        attrReq.setDataType(dev.abstratium.abstrapact.product.entity.PartAttributeDefinition.DataType.STRING);
