...
docker push ghcr.io/abstratium-dev/abstrapact:$VERSION
docker push ghcr.io/abstratium-dev/abstrapact:latest
...
echo "  - ghcr.io/abstratium-dev/abstrapact:$VERSION"
echo "  - ghcr.io/abstratium-dev/abstrapact:latest"
